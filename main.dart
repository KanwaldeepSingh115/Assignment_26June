...
import 'package:o7_tasks/assignment_26june.dart';
import 'package:o7_tasks/revision_25june.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      //Bottom Nav Bar using Column/Row Combination
      home: const BottomNav(),

      //Bottom Nav Bar with Tab Layout Combination
